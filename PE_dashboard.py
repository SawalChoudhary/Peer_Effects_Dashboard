...
# ####################################################################################
# ## some additions
tags = {'district': 'District Name', 'relationship': 'relationship with wm', 'politician_edu': 'Highest education of resp', 'politican_rel': 'Religion of resp', 'mar_status': 'Marital status of respondent', 'resp_caste_cat': 'Caste category', 'resp_jati': 'Jati name', 'caste_sc': 'SC from survey', 'wm_bef': 'Ever WM before', 'wm_years': 'How many times, if WM before', 'wm_familybefore': 'Ever WM before, from family', 'wm_familyyears': 'How many times, if WM from family before', 'pol_infamily': 'Anyone politician in family', 'self_emp': 'Any other job self', 'inc_sor': 'Primary HH source of income', 'govt_empinfam': 'Any govt employee in family', 'wm_train': 'received training', 'wm_app': 'E-gramswaraj app', 'wm_app_use': 'last app usage', 'wm_watersupply': 'type of water supply connection village', 'wm_moneycol': 'collected money Nal Jal scheme', 'whatsapp': 'using whatsapp', 'whatsapp_number': 'same calling and whatsapp number', 'whatsapp_self': 'whatsapp in phone', 'message': 'frequency of reading whatsapp messages?', 'wm_wagroup': 'if other wm WA group', 'join_interestyesno': 'wanted to do discuss with other wm', 'join_interest': 'work related discussion partner', 'sc_group': 'group of preference for SC member', 'scheme_noproblem': 'scheme with least or no problem', 'scheme_problem': 'scheme with most problem', 'citiprbrt': 'Row total of schems problem to citizen', 'phone_mukhiya': 'Mukhiya Phone number', 'phone_scret': 'Panchayat secretary number', 'phone_bpro': 'BPRO phone number', 'phone_lasttimebpro': 'Last talk BPRO', 'phone_bdo': 'BDO phone number', 'phone_lasttimebdo': 'Last talk to BDO', 'interaction_gp': 'work related discussion with WM in GP', 'candidate_gp_count': 'Network in GP', 'interaction_block': 'work related discussion with WM outside GP and in block', 'candidate_block_count': 'Network in block', 'interaction_samedist': 'discussion with WM same block', 'candidate_samedist_count': 'Network in Dist', 'interaction_outside': 'work related discussion with WM outside the district', 'candidate_outside_count': 'Network in outside dist', 'acctrt': 'Row total of WM account steps', 'awasrt': 'Row total of awas steps', 'naligalirt': 'Row total of naligali steps', 'solarlightrt': 'Row total of solar light steps', 'schknwrt': 'Row total of WMs responsibilities', 'schconfirt': 'Row total of confidence in schemes', 'polpref_self': 'support any pol party self', 'pol_party_part': 'Involvement in the political party', 'polpref_supportelec': 'Any politicial support', 't_dummy': 'Treatment condition'}
var, labels = zip(*tags.items())
